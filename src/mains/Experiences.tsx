        ...
        <>
            <StyledMain>
                ...
                <StyledH3>Software Development Intern — TechNova Solutions, Boston, MA <em>(Summer 2024)</em></StyledH3>
                    <StyledP>Built and deployed a company intranet portal using React and Node.js.</StyledP>
                    <StyledP>Designed reusable UI components, improving development speed by 30%.</StyledP>
                    <StyledP>Wrote unit tests to ensure code reliability and documented features for future interns.</StyledP>
                <StyledP>
                ...
                <StyledH3>Teaching Assistant (Intro to Python) — Boston University <em>(2023–2024)</em></StyledH3>
                    <StyledP>Assisted in grading assignments and holding weekly office hours.</StyledP>
                    <StyledP>Designed practice problems and reviewed solutions to reinforce key concepts.</StyledP>
                <StyledP>
                ...
                <StyledH3>IT Support Assistant — Boston University IT Help Desk <em>(2022–2023)</em></StyledH3>
                    <StyledP>Provided technical support to students and faculty, resolving hardware and software issues.</StyledP>
                    <StyledP>Assisted in configuring accounts, resetting passwords, and troubleshooting campus network access.</StyledP>
                    <StyledP>Documented common issues and created step-by-step guides, reducing repeat support requests.</StyledP>
                <StyledP>
